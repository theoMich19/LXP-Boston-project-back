...
class ApplicationService:
            ...
            for app in applications:
                ...
                if job_offer:
                    ...
                    result.append({
                        ...
                        "job_salary_min": float(job_offer.salary_min) if job_offer.salary_min else None,
                        "job_salary_max": float(job_offer.salary_max) if job_offer.salary_max else None
                    })
    ...
    async def get_job_applications(self, db: Session, job_offer_id: int, hr_user: User,
        ...
        Args:
            db: Session de base de données
            job_offer_id: ID de l'offre d'emploi (integer)
            hr_user: Utilisateur RH
        ...
        try:
            ...
            for app in applications:
                ...
                if user:
                    ...
                    latest_cv = db.query(CV).filter(CV.user_id == app.user_id).order_by(CV.upload_date.desc()).first()
